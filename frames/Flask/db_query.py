...
class ClassTeacher(Base):
    ...
    teacher_id = Column(
        Integer, ForeignKey('teacher.teacher_id'), primary_key=True)
...
session.add(
    Student(name=u"王晓帅", age=9, gender=u'男', address=u"浦东新区", class_id=1))
session.add(
    Student(name=u"林文龙", age=9, gender=u'男', address=u"黄浦区", class_id=1))
session.add(
    Student(name=u"李霞", age=10, gender=u'女', address=u"B3F1", class_id=1))
session.add(
    Student(name=u"侯梦", age=9, gender=u'女', address=u"南汇县", class_id=2))

session.add(
    Teacher(name=u"王天来", gender=u'男', telephone='56340688', address=u"浦东新区"))
session.add(
    Teacher(name=u"吴芬", gender=u'女', telephone='34129983', address=u"浦东新区"))
